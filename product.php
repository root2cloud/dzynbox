...
elseif(isset($_POST['form_add_to_wishlist'])) {
    ...
    if(isset($_SESSION['wishlist_p_id'])) {
        ...
        // ... (similar logic for size, color, etc.)
        ...
        if($added == 1) {
            ...
            // $_SESSION['wishlist_zipmachine'][$new_key] = $_POST['zipmachine'];

            $success_message1 = 'Product is added to the wishlist successfully!';
        }
					...
					<div class="row">
						...
						<div class="col-md-7">
							...
							<div class="btn-cart btn-cart1">
                                ...
                                <!-- whistlist -->
                                <button type="" class="fa fa-heart btn111 btn-danger" name="form_add_to_wishlist"style="display: inline-block; margin-left: 25px;">  Wishlist</button>
							</div>
                            </form>
							<div class="share">
