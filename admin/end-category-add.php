...
if(isset($_POST['form1'])) {
    ...
    // Validate category selections and input
    ...
    if($path != '') {
        ...
        $valid = 0;
        $error_message .= 'You must upload an image<br>';
    }
    ...
    if($valid == 1) {
        ...
        // Auto rename image and move to uploads folder
        $final_name = 'ecat_' . time() . '.' . $ext;
        move_uploaded_file($path_tmp, 'uploads/' . $final_name);

        // Insert into database
        $statement = $pdo->prepare("INSERT INTO tbl_end_category (ecat_name, ecat_image, mcat_id) VALUES (?,?,?)");
        $statement->execute(array($_POST['ecat_name'], $final_name, $_POST['mcat_id']));
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <!-- Upload Image -->
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Upload Image <span>*</span></label>
                            <div class="col-sm-4">
